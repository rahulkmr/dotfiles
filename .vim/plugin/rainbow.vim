...
hi level1c ctermfg=blue
hi level2c ctermfg=red
hi level3c ctermfg=green
hi level4c ctermfg=yellow
hi level5c ctermfg=grey
hi level6c ctermfg=cyan
hi level7c ctermfg=magenta
hi level8c ctermfg=brown
hi level9c ctermfg=white
hi level10c ctermfg=darkmagenta
hi level11c ctermfg=darkcyan
hi level12c ctermfg=darkgrey
hi level13c ctermfg=darkyellow
hi level14c ctermfg=darkgreen
hi level15c ctermfg=darkred
hi level16c ctermfg=darkblue
